...
CREATE TABLE `orderdetailstable` (
  ...
  KEY `Ord_FK` (`OrderId`),
  KEY `Prod2_FK` (`ProductId`),
  CONSTRAINT `Ord_FK` FOREIGN KEY (`OrderId`) REFERENCES `orderstable` (`OrderId`),
  CONSTRAINT `Prod2_FK` FOREIGN KEY (`ProductId`) REFERENCES `producttable` (`ProductId`)
